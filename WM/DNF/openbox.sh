...
wget https://raw.githubusercontent.com/AryanVBW/LinuxDroid/refs/heads/main/Fedora/LXDE/vncserver-start -O /usr/local/bin/vncserver-start
wget https://raw.githubusercontent.com/AryanVBW/LinuxDroid/refs/heads/main/Fedora/LXDE/vncserver-stop -O /usr/local/bin/vncserver-stop
